'''
    ...
    function swap_values() to swap the values, and prints the swapped values
    on a single line separated with spaces.
...
if __name__ == '__main__':
    user_val1 = int(input('Enter four integers: '))
    user_val2 = int(input('Enter four integers: '))
    user_val3 = int(input('Enter four integers: '))
    user_val4 = int(input('Enter four integers: '))
